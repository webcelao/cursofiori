		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MFA - APP FIORI",
									"targetURL": "#zmfaappfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmfaappfiori-display": {
								"semanticObject": "zmfaappfiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmfaappfiori",
									"url": sap.ui.require.toUrl("zmfaappfiori")
								}
							}
						}
					}
